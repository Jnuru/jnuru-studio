...
function winsComputeData() {
  ...
  let milestone;
  if (n >= 300) {
    milestone = { eyebrow:"Milestone · 300 SEO pages", quote:`${n} pages, written by hand. That's how you own every search result in the region.`, next: null };
  } else if (n >= 250) {
    milestone = { eyebrow:"Milestone · 250 SEO pages", quote:`${n} SEO pages, written by hand. No wonder Redwood&nbsp;Motors ranks as the region's <span class="wins-quote-accent">#1 dealer group</span>.`, next:`Next milestone: 300 pages — ${300-n} to go.` };
  } else if (n >= 100) {
