(function () {
  const ROOFTOPS_KEY = "rooftop-rooftops";
  const DRIVE_KEY = "rooftop-drive-connection";
      ...
      <section id="rooftopsManager" class="rooftops-manager" hidden aria-label="Rooftop management">
        ...
        <form id="rooftopForm" class="rooftop-form" hidden>
          <div class="rooftop-form-grid">
            <label>Rooftop name<input id="rooftopNameInput" type="text" placeholder="Redwood Honda" /></label>
